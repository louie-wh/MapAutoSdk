...
import static com.baidu.mapautosdk.cluster.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public DefaultClusterRenderer(Context context, View map, ClusterManager<T> clusterManager) {
        mMap = map;
    ...
    private class ViewModifier extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            renderTask.setMapZoom(BDAutoMapFactory.getAutoMapManager().getAutoMapStatus().zoomLevel);
    ...
    private class RenderTask implements Runnable {
        ...
        public void run() {
            ...
            final LatLngBounds visibleBounds = BDAutoMapFactory.getAutoMapManager().getAutoMapStatus().latLngRound;
